...
//        cc.openConnection();
//        cc.sendData("GET_ONLINE_PLAYERS", null);
//        ArrayList<Player> onlinePlayers = cc.getPlayers();
//        listPlayer = onlinePlayers;
//        setOnlineTable(onlinePlayers);
...
//        cc.openConnection();
//        cc.sendData("GET_RANK_PLAYERS", null);
//        ArrayList<Player> rankPlayers = cc.getPlayers();
//        listRankPlayer = rankPlayers;
//        setRankTable(rankPlayers);
    }
    ...
    private void initComponents() {
        ...
        rankTable.setModel(new DefaultTableModel(
            ...
            Class[] types = new Class [] {
                Integer.class, String.class, Float.class, Float.class, String.class
            };
...
//        rankTable.get
    ...
    private JComboBox<String> rankType;
